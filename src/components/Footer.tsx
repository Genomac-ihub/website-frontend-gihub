...
export default function Footer() {
    return (
        <>
            <footer className="bg-black text-white mt-[10px]">
                <div className="w-full max-w-screen-xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                        ...
                        <div className="lg:col-span-1">
                            ...
                            <div className="text-md font-bold text-white/80 space-y-1">
                                <p> Home of innovation</p>
                        ...
                        <div>
                            ...
                            <nav className="space-y-3">
                                ...
                                <a href="/faqs" className="block text-white/80 hover:text-white transition-colors">FAQs</a>
                            </nav>
                        </div>
                        ...
                        <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-4">
                                ...
                                <p className="text-xs text-white/60">
                                    ©2025 G-iHub Technologies Limited. All rights reserved.
                                </p>
                            </div>
